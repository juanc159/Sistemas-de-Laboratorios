								      ...
								      { 
								              ...
								              foreach ($exp as $value)
								              {
								                ...
								                { 
								                  ...
								                  echo '<td>
								                  <span data-toggle="tooltip" title=""   data-original-title="'.$texto.' ">
								                  <input required  type="text" maxlength="3"  name="dato_'.$lab[$j]['numero'].'_'.$dep[$d]['nombre'].'_'.$e.'" id="dato_'.$lab[$j]['numero'].'_'.$dep[$d]['nombre'].'_'.$e.'" class="form-control m-b" value="0" onkeypress="return SoloNumeros(event)"></span>
								                  </td>';  
