        ...
        <div class="row">
          <div class="col-md-3">
              <div class="form-group"> 
                <h3 class="box-title">Modificar Acta de Descarte</h3>
              </div>
          </div> 
          <div class="col-md-3">
              <div class="form-group"> 
          ...
          <div class="col-md-3">
              <div class="form-group">  
                <a target="v"  class="btn btn-block btn-primary fa fa-file-pdf-o" href="<?php echo base_url().'quimica/pdfDescarte/'.$nro_acta.'/'.$fecha_ano ?>"> Vista Previa</a>
              </div>
          </div> 
          <div class="col-md-3">
            <div class="form-group">  
              <a class="btn btn-block btn-danger" href="<?php echo base_url().'quimica/descarte/'.$fecha_ano_R?>">CANCELAR / REGRESAR</a>
            </div>
          </div>  
        </div>
      </div><!-- /.box-header -->
      ...
      <form  action="" method="post">
        <div class="box-body"> 
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                ...
                <label>FECHA REALIZACION:</label> <?php echo $fecha_actual;  ?>  
          ...
          <div class="row"> 
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="empresa" id="empresa" value="<?php echo $dato->empresa ?>">
              </div>
            </div>  
             ...
             <div class="col-md-3">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="exportador" id="exportador" value="<?php echo $dato->exportador ?>">
              </div>
            </div>  
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>DATOS DEL JEFE DE LA COMISIÓN:</label> 
              </div>
            </div>  
          </div>
