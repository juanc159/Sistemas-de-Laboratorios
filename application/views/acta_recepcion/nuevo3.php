                ...
                <div class="box-body">
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <td> 
                        <a href="<?php echo base_url()?>acta_recepcion/nuevo2/<?php echo $dato->nro_acta?>">EVIDENCIAS</a>
                      </td>
                      <td> 
...
<?php
    ...
    ?> 
              ...
              <!-- AQUI EMPEZAMOS EL CODIGO DE LAS OBSERVACIONES PARA AGREGAR  Y MOSTRAR -->
<form action="" method="post">
            <table>
                    <tr>
                      ...
                      <td>
                        <textarea id="observaciones" name="observaciones" rows="3" cols="90"></textarea> 
                      </td>
                    </tr>
                    <tr>
                      <td> 
...
<div class="box">
                <div class="box-header">
                 <h1 class="box-title"><strong> OBSERVACIONES:</strong> </h1>
                </div><!-- /.box-header -->
                <div class="box-body">
                ...
                <?php
                  foreach($datos_obs as $dato)
                  {
                ?> 
                  <tr> 
                    <td>
                      <h4 class="box-title"><strong> # <?php echo $dato->id_observaciones ?>:</strong> </h4>
                    </td>
                    <td>
                      <?php echo $dato->des_observaciones ?>
                    </td>
                  </tr> 
                <?php
                  }
