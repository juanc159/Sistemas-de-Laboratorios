  ...
  <section class="content-header">
   ...
   <section class="content">
    ...
    <div class="box">
      ...
      $query = $this->db->query('SELECT * FROM div_inf_for.tipo_experticia where id_tipo_experticia='.$id); 
      $datos=$query->result(); 
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="des_experticia" id="des_experticia" value="<?php echo $dato->des_experticia ?>">
              </div>
            </div> 
          </div>
