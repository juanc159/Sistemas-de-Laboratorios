  ...
  <section class="content-header">
   ...
   <section class="content">
    ...
    <div class="box">
      ...
      <form  action="nuevoUnidad" method="post">
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="des_unidad_solicitantente" id="des_unidad_solicitantente" value="<?php echo set_value("des_unidad_solicitantente")?>">
              </div>
            </div> 
          </div>
