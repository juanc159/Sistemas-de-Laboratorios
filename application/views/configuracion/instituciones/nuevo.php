  ...
  <section class="content-header">
   ...
   <section class="content">
    ...
    <div class="box">
        ...
        <div class="row">
          <div class="col-md-9">
              <div class="form-group"> 
                <h3 class="box-title">Registrar Institucion</h3>
              </div>
            </div> 
            <div class="col-md-3">
              <div class="form-group"> 
      ...
      <form  action="nuevoInstitucion" method="post">
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="des_institucion_solicitante" id="des_institucion_solicitante" value="<?php echo set_value("des_institucion_solicitante")?>">
              </div>
            </div> 
          </div>
