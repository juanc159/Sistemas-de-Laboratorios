...
<div class="content-wrapper">
  ...
  <section class="content-header">
   ...
   <section class="content">
     ...
     $documento='quimica/pdfDescarte/'.$nro_acta.'/'.$fecha_a;

     if ($datos) {
      foreach($datos as $dato)
      {
        $id_remision_des=$dato->id_remision_des;
        ...
        $documento='uploads/archivos_descartes/'.$archivo_pdf;
    ...
    <form  method="post" accept-charset="utf-8" id="miformulario" name="form" enctype="multipart/form-data">  
      ...
      <?php } ?>
        ...
        <div class="row">
            <div class="col-md-6">
              <div class="form-group"> 
                <a class="btn btn-block btn-danger" href="<?php echo base_url().'secretaria/remision_descarte/'.$fecha_ano_R?>">CANCELAR / REGRESAR</a>
              </div>
            </div> 
            <?php 
            if ($readonly==NULL)
