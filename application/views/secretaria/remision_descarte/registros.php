        ...
        <div class="row">
          <div class="col-md-9">
              <div class="form-group"> 
                <h3 class="box-title">REMISIONES DE DESCARTES</h3>
              </div>
            </div>  
            <div class="col-md-3">
              <div class="form-group"> 
          ...
          <div class="col-md-12">
            <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
                      ...
                      { 
                        $datos3=$this->secretaria_model->getDescartes_id($dato->nro_acta);
                        $label="";
                        if(!$datos3){
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a    class="btn btn-app"  href="<?php echo base_url().'secretaria/nuevoDescarte/'.$dato->nro_acta.'/'.$dato->fecha_acta ?>"><i class="fa fa-link"></i> VER INFORMACION</a>
                          </td>
                      </tr> 
                    <?php
                    }
