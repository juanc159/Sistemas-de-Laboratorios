        ...
        <div class="row">
          <div class="col-md-9">
              <div class="form-group"> 
                <h3 class="box-title">REMISIONES DE TOXICOLOGIA</h3>
              </div>
            </div>  
            <div class="col-md-3">
              <div class="form-group"> 
            ...
            <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
                      ...
                      { 
                        $fecha_a=$this->uri->segment(3);
                        $where = array(
                                'id_remision_tox' => $dato->nro_acta, 
                                'remision_ano' => $fecha_a
                              );
                        $datos3=$this->acta_recepcion_model->buscar('quimica.remision_toxicologico',$where);
                        $label="";
                        if(!$datos3){
                        ...
                        foreach($datos3 as $dato3)
                          { 
                            ...
                            if ($dato3->status_remi_tox==0)
                            {
                              $status_remi='EN ESPERA';  
                              $label="label-danger";                          
                            }
                            if ($dato3->status_remi_tox==1)
                            {
                              $status_remi='LISTO';
                              $label="label-success";
                            }
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a    class="btn btn-app"  href="<?php echo base_url().'secretaria/nuevoToxicologico/'.$dato->nro_acta.'/'.$dato->fecha_tox ?>"><i class="fa fa-link"></i> VER INFORMACION</a>
                          </td>
                      </tr> 
                    <?php
                    }
