...
<div class="content-wrapper">
  ...
  <section class="content-header">
   ...
   <section class="content">
     ...
     $documento='quimica/pdfToxicologico/'.$nro_acta.'/'.$fecha_a;

     if ($datos) {
      foreach($datos as $dato)
      {
        $id_remision_bar=$dato->id_remision_tox;
        $num_ofi_remision=$dato->num_ofi_remi_tox;
        $fecha_remision=$dato->fecha_remi_tox;
        $hora_remision=$dato->hora_remi_tox;
        $obs_remision=$dato->obs_remi_tox;
        $archivo_pdf=$dato->archivo_pdf_remi_tox;
        $status_remi=$dato->status_remi_tox;

        $documento='uploads/archivos_toxicologico/'.$archivo_pdf;
    ...
    <form  method="post" accept-charset="utf-8" id="miformulario" name="form" enctype="multipart/form-data">  
      ...
      <?php } ?>
        ...
        <div class="row">
            <div class="col-md-6">
              <div class="form-group">  
                <a class="btn btn-block btn-danger" href="<?php echo base_url().'secretaria/remision_toxicologico/'.$fecha_ano_R?>">CANCELAR / REGRESAR</a>
