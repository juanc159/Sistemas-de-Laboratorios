...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		else if (!$this->ion_auth->is_admin()) // remove this elseif if you want to enable this for non-admins
		{
			...
			show_error('NECESITA PRIVILEGIOS DE ADMINISTRADOR PARA PODER ACCEDER A ESTA PAGINA.');
		}
		else
		{
	...
	*/
	...
	public function edit_user($id)
	{
		...
		$this->data['grado'] = [
				...
				'id' => 'grado',
				'type' => 'text',
				'value' => $this->form_validation->set_value('grado', $user->grado),
				'class' => 'form-control',
			];
		$this->data['password'] = [
			'name' => 'password',
	...
	public function create_group()
	{
		...
		// validate form input
		$this->form_validation->set_rules('group_name', $this->lang->line('create_group_validation_name_label'), 'trim|required|alpha_dash|max_length[2]');
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			if ($new_group_id)
			{
				...
				// redirect them back to the admin page
				$this->session->set_flashdata('message', $this->ion_auth->messages());
				redirect("configuracion/grupos", 'refresh');
			}
		}
		else
		{
